...
let FirebaseService = class FirebaseService {
    ...
    getVehiculo(id) {
        return new Promise((resolve, reject) => {
            this.afAuth.user.subscribe(currentUser => {
                if (currentUser) {
                    this.snapshotChangesSubscription = this.afs.doc('vehiculo/' + id).valueChanges()
                        .subscribe(snapshots => {
                        resolve(snapshots);
                    }, err => {
                        reject(err);
    ...
    getPais(id) {
        return new Promise((resolve, reject) => {
            this.afAuth.user.subscribe(currentUser => {
                if (currentUser) {
                    this.snapshotChangesSubscription = this.afs.doc('pais/' + id).valueChanges()
                        .subscribe(snapshots => {
                        resolve(snapshots);
                    }, err => {
                        reject(err);
    ...
    getProvincia(id) {
        return new Promise((resolve, reject) => {
            this.afAuth.user.subscribe(currentUser => {
                if (currentUser) {
                    this.snapshotChangesSubscription = this.afs.doc('provincia/' + id).valueChanges()
                        .subscribe(snapshots => {
                        resolve(snapshots);
                    }, err => {
                        reject(err);
...
//# sourceMappingURL=default~actualizar-pais-actualizar-pais-module~actualizar-provincia-actualizar-provincia-module~actu~c9caa3cf-es2015.js.map