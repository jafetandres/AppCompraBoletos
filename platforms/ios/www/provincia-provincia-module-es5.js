...
var ProvinciaPageModule = /** @class */ (function () {
    function ProvinciaPageModule() {
    }
...
var ProvinciaPage = /** @class */ (function () {
    function ProvinciaPage(loadingCtrl, authService, router, route) {
        this.loadingCtrl = loadingCtrl;
        this.authService = authService;
        this.router = router;
        this.route = route;
    }
    ProvinciaPage.prototype.ngOnInit = function () {
        if (this.route && this.route.data) {
            this.getData();
        }
    };
    ProvinciaPage.prototype.getData = function () {
    ...
    ProvinciaPage.prototype.presentLoading = function (loading) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ProvinciaPage.prototype.logout = function () {
        var _this = this;
    ...
    ProvinciaPage.ctorParameters = function () { return [
...
var ProvinciaResolver = /** @class */ (function () {
    function ProvinciaResolver(firebaseService) {
        this.firebaseService = firebaseService;
    }
    ProvinciaResolver.prototype.resolve = function () {
        return this.firebaseService.getProvincias();
    };
    ProvinciaResolver.ctorParameters = function () { return [
...
//# sourceMappingURL=provincia-provincia-module-es5.js.map