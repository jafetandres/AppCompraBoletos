(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~actualizar-pais-actualizar-pais-module~actualizar-provincia-actualizar-provincia-module~actu~c9caa3cf"],{
...
var FirebaseService = /** @class */ (function () {
    ...
    FirebaseService.prototype.getRutas = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.afAuth.user.subscribe(function (currentUser) {
                if (currentUser) {
                    _this.snapshotChangesSubscription = _this.afs.collection('ruta').snapshotChanges();
                    resolve(_this.snapshotChangesSubscription);
                }
            });
        });
    ...
    FirebaseService.prototype.getCiudades = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.afAuth.user.subscribe(function (currentUser) {
                if (currentUser) {
                    _this.snapshotChangesSubscription = _this.afs.collection('ciudad').snapshotChanges();
                    resolve(_this.snapshotChangesSubscription);
                }
            });
        });
    };
    FirebaseService.prototype.getVehiculos = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.afAuth.user.subscribe(function (currentUser) {
                if (currentUser) {
                    _this.snapshotChangesSubscription = _this.afs.collection('vehiculo').snapshotChanges();
                    resolve(_this.snapshotChangesSubscription);
                }
            });
        });
    };
    FirebaseService.prototype.getBoletos = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.afAuth.user.subscribe(function (currentUser) {
                if (currentUser) {
                    _this.snapshotChangesSubscription = _this.afs.collection('boleto').snapshotChanges();
                    resolve(_this.snapshotChangesSubscription);
                }
            });
        });
    ...
    FirebaseService.prototype.getVehiculo = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.afAuth.user.subscribe(function (currentUser) {
                if (currentUser) {
                    _this.snapshotChangesSubscription = _this.afs.doc('vehiculo/' + id).valueChanges()
                        .subscribe(function (snapshots) {
                        resolve(snapshots);
                    }, function (err) {
                        reject(err);
    ...
    FirebaseService.prototype.getPais = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.afAuth.user.subscribe(function (currentUser) {
                if (currentUser) {
                    _this.snapshotChangesSubscription = _this.afs.doc('pais/' + id).valueChanges()
                        .subscribe(function (snapshots) {
                        resolve(snapshots);
                    }, function (err) {
                        reject(err);
    ...
    FirebaseService.prototype.getProvincia = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.afAuth.user.subscribe(function (currentUser) {
                if (currentUser) {
                    _this.snapshotChangesSubscription = _this.afs.doc('provincia/' + id).valueChanges()
                        .subscribe(function (snapshots) {
                        resolve(snapshots);
                    }, function (err) {
                        reject(err);
    ...
    FirebaseService.prototype.actualizarVehiculo = function (key, value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('vehiculo').doc(key).set(value)
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    FirebaseService.prototype.actualizarPais = function (id, value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('pais').doc(id).set(value)
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    FirebaseService.prototype.actualizarProvincia = function (id, value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('provincia').doc(id).set(value)
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    ...
    FirebaseService.prototype.eliminarPais = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('pais').doc(id).delete()
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    FirebaseService.prototype.eliminarProvincia = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('provincia').doc(id).delete()
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    FirebaseService.prototype.deleteVehicle = function (Key) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('vehiculo').doc(Key).delete()
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    FirebaseService.prototype.deleteBoleto = function (Key) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('boleto').doc(Key).delete()
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    ...
    FirebaseService.prototype.crearCiudad = function (value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('ciudad').add({
    ...
    FirebaseService.prototype.crearVehiculo = function (value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('vehiculo').add({
                placa: value.placa,
                modelo: value.modelo,
                marca: value.marca,
                color: value.color,
    ...
    FirebaseService.prototype.crearBoleto = function (value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('boleto').add({
                fecha: value.fecha,
                estado: value.estado,
                valor: value.valor,
...
//# sourceMappingURL=default~actualizar-pais-actualizar-pais-module~actualizar-provincia-actualizar-provincia-module~actu~c9caa3cf-es5.js.map