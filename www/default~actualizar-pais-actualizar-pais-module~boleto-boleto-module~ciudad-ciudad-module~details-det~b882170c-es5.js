(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~actualizar-pais-actualizar-pais-module~boleto-boleto-module~ciudad-ciudad-module~details-det~b882170c"],{
...
var FirebaseService = /** @class */ (function () {
    ...
    FirebaseService.prototype.eliminarPais = function (taskKey) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var currentUser = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
            _this.afs.collection('pais').doc(taskKey).delete()
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
...
//# sourceMappingURL=default~actualizar-pais-actualizar-pais-module~boleto-boleto-module~ciudad-ciudad-module~details-det~b882170c-es5.js.map