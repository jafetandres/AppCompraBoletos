...
var NuevaRutaPageRoutingModule = /** @class */ (function () {
    function NuevaRutaPageRoutingModule() {
    }
    ...
    return NuevaRutaPageRoutingModule;
}());
...
var NuevaRutaPage = /** @class */ (function () {
    function NuevaRutaPage(toastCtrl, loadingCtrl, router, formBuilder, firebaseService, webview) {
